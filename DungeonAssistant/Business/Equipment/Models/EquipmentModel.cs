...
public class EquipmentModel : ObservableObject, IEquipmentModel
{
    ...
    private string _armorIconPath = "Images/ArmorIcon.png";
    ...
    private string _battleAxeIconPath = "Images/BattleAxeIcon.png";
    private string _bowIconPath = "Images/BowIcon.png";
    private string _crossbowIconPath = "Images/CrossbowIcon.png";
    private string _daggerIconPath = "Images/DaggerIcon.png";
    private string _hatchetIconPath = "Images/HatchetIcon.png";
    private string _potionIconPath = "Images/PotionIcon.png";
    private string _shieldIconPath = "Images/ShieldIcon.png";
    private string _spearIconPath = "Images/SpearIcon.png";
    private string _swordIconPath = "Images/SwordIcon.png";
    private string _wandIconPath = "Images/WandIcon.png";
    private string _warhammerIconPath = "Images/WarhammerIcon.png";
